"""
Annotated heatmaps for hierarchical result
==================
...
flights_long = sns.load_dataset("clustering_hierarchical_vec25")
...
plt.savefig('/Users/Ahmed/Downloads/figure_hier.pdf', bbox_inches='tight')
plt.show()  
plt.close()