"""
Annotated heatmaps for kmeans result
==================
...
flights_long = sns.load_dataset("clustering_kmeans_vec25")
...
plt.savefig('/Users/Ahmed/Downloads/figure_kmeans.pdf', bbox_inches='tight')
plt.show()  
plt.close()